  ...
  return (
    ...
    >
      ...
      <div className="flex h-[40vh] w-[80vw] flex-col flex-wrap md:flex-row justify-between md:space-x-4 md:flex-nowrap">
        <div className="md:w-1/4 md:max-w-[20rem] grow bg-white/40 rounded-lg mt-4 shadow-lg p-4 text-center items-center flex">
          <h1 className="font-bold text-xl text-custom-purple">How much money did each genre make each year ?</h1>
        </div>
